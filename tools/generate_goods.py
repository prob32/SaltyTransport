...
Storage backends (see ARCHITECTURE_V2.md section 1):
    maps  - per-good data in variable maps keyed by flag:<good> (1.13.7+).
    vars  - per-good data in name-mangled variables (pre-1.13.7 pattern).
...
STORAGE = "maps"  # overridden by --storage
...
def main():
    ...
    p.add_argument("--storage", choices=["maps", "vars"], default="maps")
