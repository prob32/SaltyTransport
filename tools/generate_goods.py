...
def gen_tooltip():
    ...
    L = [AUTOGEN,
         ...
         "\t\t\t\t\t\t}",
         "",
         "\t\t\t\t\t\t# proximity weight from the click-chain BF map",
         "\t\t\t\t\t\tscope:stl_depot_state = {",
         "\t\t\t\t\t\t\tset_local_variable = {",
         "\t\t\t\t\t\t\t\tname = stl_pw",
         "\t\t\t\t\t\t\t\tvalue = {",
